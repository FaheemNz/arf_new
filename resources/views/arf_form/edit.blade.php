        ...
        <div class="row justify-content-center">
            <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-xl-7 col-lg-10">
                ...
                <div class="alert alert-success alert-dismissible" role="alert">
                    ...
                    <p><?php echo isset($success) ? $success : 'ARF Request has been submitted.' ?></p>
                                        ...
                                        <table class="table table-sm m-0 table-striped table-bordered" id="arf-header-table">
                                            <tbody class="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <input class="form-control arf-form-control" type="number" name="arf_emp_id" value="{{ $arf->emp_id }}" readonly required />
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
